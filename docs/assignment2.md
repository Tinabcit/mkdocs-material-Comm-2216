...
**Norman Principle Impact – Design:**  
The site violates **Aesthetic and Minimalist Design** due to excessive clutter. **Credibility and Trust** are also negatively affected, as poor design reduces user confidence.
...
**Benefits for Navigation Functionality:**  
These changes improve user confidence and reduce confusion, supporting **Consistency and Standards**.
...
Animations enhance feedback and user awareness without overwhelming the user.
...
The website should be rebranded to better reflect a niche gourmet market. The design should appeal to corporate catering clients while balancing trendy elements with elegance and professionalism. Visuals should emphasize quality, freshness, and craftsmanship.
...
Pricing must be consistent and clearly displayed. Redundant pages and unnecessary information should be removed.

### Combine Overlapping Content

Repeated FAQ questions should be merged. The **Resources** and **Occasions** pages should be combined, and delivery information should be included within the FAQ section.

## Based on Norman Heuristic Standards

Based on Norman’s usability principles, the Toronto Cupcake website suffers from multiple usability, design, and functional issues that negatively impact the user experience, particularly during browsing and purchasing.
...
## Based on the 7 Usability Factors to Focus on Improving

### Usability

Navigation, cart, and catalogue functionality must be intuitive and efficient so users can complete purchases with minimal effort.

### Credibility

Professional and consistent design across all pages, combined with high-quality imagery and clear product information, will strengthen credibility.

### Desirability

A trendy yet elegant design should visually reflect high-quality products and appeal to both individual customers and corporate clients.
