...
**What**  
Browsing cupcake options, reviewing allergen and delivery information, placing cupcake orders, and managing delivery or pickup.

**Where**  
Online, through the Toronto Cupcake website.

**When**  
As soon as possible, due to the current negative impact on usability, trust, and conversion.
...
The FAQ page should be reorganized to remove duplicated questions and unnecessary content. Information should be clearly visible without relying on confusing click-to-reveal interactions, allowing users to quickly find answers without extra effort.
